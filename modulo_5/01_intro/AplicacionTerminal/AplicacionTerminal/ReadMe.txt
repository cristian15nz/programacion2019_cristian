========================================================================
    APLICACIÓN DE CONSOLA: AplicacionTerminal Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación AplicacionTerminal.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación AplicacionTerminal.


AplicacionTerminal.vcxproj
...
AplicacionTerminal.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado AplicacionTerminal.pch y un archivo de tipos precompilados llamado StdAfx.obj.
